...
public class KeyboardGeneratorTest {
    ...
    public void createEmptyKeyboardToimii() throws Exception{
        KeyboardGenerator KBGen = new KeyboardGenerator("C:\\Users\\Hanskat\\KeyboardOptimizer\\Dokumentaatio\\Testitiedostot\\Testifilu1.txt");
    ...
    public void customKonstruktoriLasketullaKeyboardillaToimii() throws Exception {
        KeyboardGenerator KBGen = new KeyboardGenerator("C:\\Users\\Hanskat\\KeyboardOptimizer\\Dokumentaatio\\Testitiedostot\\Testifilu1.txt", "ABCDEF");
        Keyboard testKeyboard = KBGen.countInstancesOfKeysAndCreateKeyboard();
    ...
    public void customKonstruktoriLasketullaKeyboardillaTiedostossaEiOikeitaMerkkeja() throws Exception {
        KeyboardGenerator KBGen = new KeyboardGenerator("C:\\Users\\Hanskat\\KeyboardOptimizer\\Dokumentaatio\\Testitiedostot\\Testifilu1.txt", "GHI");
        Keyboard testKeyboard = KBGen.countInstancesOfKeysAndCreateKeyboard();
