...
public class KeyboardGeneratorTest {
    ...
    public void createEmptyKeyboardToimii() throws Exception{
        KeyboardGenerator KBGen = new KeyboardGenerator("src/Testitiedostot/Testifilu1.txt");
        Keyboard testKeyboard = KBGen.createEmptyKeyboard();
        assertEquals("A: 0, B: 0, C: 0, D: 0, E: 0, F: 0, G: 0, H: 0, I: 0, J: 0, K: 0, L: 0, M: 0, N: 0, O: 0, P: 0, Q: 0, R: 0, S: 0, T: 0, U: 0, V: 0, W: 0, X: 0, Y: 0, Z: 0", testKeyboard.toString());
    }
    ...
    public void defaultKonstruktoriLasketullaKeyboardillaToimii() throws Exception {
        ...
        assertEquals("A: 5, B: 7, C: 9, D: 11, E: 13, F: 15, G: 0, H: 0, I: 0, J: 0, K: 0, L: 0, M: 0, N: 0, O: 0, P: 0, Q: 0, R: 0, S: 0, T: 0, U: 0, V: 0, W: 0, X: 0, Y: 0, Z: 0", testKeyboard.toString());
    }

    @Test
    public void customKonstruktoriLasketullaKeyboardillaToimii() throws Exception {
        KeyboardGenerator KBGen = new KeyboardGenerator("src/Testitiedostot/Testifilu1.txt", "ABCDEF");
        Keyboard testKeyboard = KBGen.countInstancesOfKeysAndCreateKeyboard();
    ...
    public void customKonstruktoriLasketullaKeyboardillaTiedostossaEiOikeitaMerkkeja() throws Exception {
        KeyboardGenerator KBGen = new KeyboardGenerator("src/Testitiedostot/Testifilu1.txt", "GHI");
        Keyboard testKeyboard = KBGen.countInstancesOfKeysAndCreateKeyboard();
